...
def faceRecognize(detector='haar',threshold=0.5, write_video = False,resize_w=700,resize_h=400):
    ...
    videoWriter = cv2.VideoWriter('./record_video/out'+str(time.time())+'.mp4', fourcc, 15, (resize_w,resize_h))
...
parser.add_argument("--name", type=str, default='Caesar',
                    help="人脸姓名，英文格式")                       
